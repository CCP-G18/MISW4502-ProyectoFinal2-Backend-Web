...
@pytest.mark.parametrize("field", ["name", "description", "unit_amount", "manufacturer_id", "category_id"])
def test_create_missing_fields(field):
    ...
    assert field.replace("_", " ") in str(excinfo.value).lower()
